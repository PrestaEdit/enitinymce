!(function (l) {
            ...
            return function (o) {
                i.undoManager.transact(function () {
                    ...
                    C(i.settings) || !1 !== N(i.settings) || (n.rel = f(n.rel, "_blank" === n.target)),
                        ...
                        e
                            ? (i.focus(), o.hasOwnProperty("text") && ("innerText" in e ? (e.innerText = o.text) : (e.textContent = o.text)), i.dom.setAttribs(e, n), i.selection.select(e), i.undoManager.add())
                            : v(t)
                            ? h(i, t, n)
    ...
    t.add("linkOverrided", function (t) {
